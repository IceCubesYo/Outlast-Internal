...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UHSO[0x6];                                   // 0x02DA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8CQZ[0x7];                                   // 0x0319(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RSA7[0x7];                                   // 0x03D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3I70[0x3];                                   // 0x0449(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		bool                                                       HasNewItemsinSubCategory;                                // 0x0450(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void SetUpgradeItemState(EMenuUpgradeItemState upgradeItemState);
		void SetBaseColor(const struct FSlateColor& Color);
		void SetCanShowIcon(bool CanShowIcon);
		void SetIcon(class UTexture2D* Icon, bool matchSize);
