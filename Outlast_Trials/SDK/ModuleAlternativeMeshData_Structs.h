...
namespace CG
{
	 ...
	 * Size -> 0x0014
	 */
	struct FModuleAlternativeMeshData
	{
	public:
		...
		int32_t                                                    Recurence_16_F259B0FB42FC3100A87A15A0144A11FC;           // 0x0008(0x0004) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
