...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function RBAnimNotify_PlayAnimationOnFutterman.RBAnimNotify_PlayAnimationOnFutterman_C.GetNotifyName");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function RBAnimNotify_PlayAnimationOnFutterman.RBAnimNotify_PlayAnimationOnFutterman_C.Received_Notify");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass RBAnimNotify_PlayAnimationOnFutterman.RBAnimNotify_PlayAnimationOnFutterman_C");
		return ptr;
	}
