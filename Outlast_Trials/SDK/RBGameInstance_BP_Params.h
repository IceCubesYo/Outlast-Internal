...
namespace CG
{
	 ...
	 */
	struct URBGameInstance_BP_C_TravelToMap_Params
	{
	public:
	 ...
	 */
	struct URBGameInstance_BP_C_ExecuteUbergraph_RBGameInstance_BP_Params
	{
	public:
		int32_t                                                    EntryPoint;                                              // 0x0000(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		unsigned char                                              UnknownData_JPFP[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
