...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PhotoFinishOverheadWidget.PhotoFinishOverheadWidget_C.SetName");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PhotoFinishOverheadWidget.PhotoFinishOverheadWidget_C.Event_Refresh");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PhotoFinishOverheadWidget.PhotoFinishOverheadWidget_C.ExecuteUbergraph_PhotoFinishOverheadWidget");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PhotoFinishOverheadWidget.PhotoFinishOverheadWidget_C");
		return ptr;
	}
