...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7CHZ[0x6];                                   // 0x004A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5FF8[0x7];                                   // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_5P1G[0x88];                                  // 0x0060(0x0088) MISSED OFFSET (PADDING)
	...
	public:
		...
		class FScriptMulticastDelegate                             OnProgress;                                              // 0x0040(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFail;                                                  // 0x0050(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_55T8[0x78];                                  // 0x0060(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
