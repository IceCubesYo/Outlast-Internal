...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function ScorePlayerEntry.ScorePlayerEntry_C.Setup");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function ScorePlayerEntry.ScorePlayerEntry_C.Init");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ScorePlayerEntry.ScorePlayerEntry_C");
		return ptr;
	}
