...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_EVRW[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_UBH2[0x4];                                   // 0x313C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UgooseberryFace_AnimBP_C*                            GooseberryFacePlayer;                                    // 0x3148(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		bool                                                       FuttermanSpeaking;                                       // 0x3150(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
		...
		unsigned char                                              UnknownData_UEVZ[0x5];                                   // 0x3153(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class Ugooseberry_AnimBP_C*                                GooseberryAnimBP;                                        // 0x3158(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_2WEV[0x3];                                   // 0x3165(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
