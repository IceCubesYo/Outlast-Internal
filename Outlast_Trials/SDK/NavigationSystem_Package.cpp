...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UNavArea_Traversable3.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UNavArea_Traversable3::StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable3");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UNavArea_Traversable5.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UNavArea_Traversable5::StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable5");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UNavArea_Traversable10.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UNavArea_Traversable10::StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable10");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UNavArea_Traversable25.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UNavArea_Traversable25::StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable25");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UNavArea_Traversable50.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UNavArea_Traversable50::StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class NavigationSystem.NavArea_Traversable50");
		return ptr;
	}
	 ...
	 */
	ENavigationQueryResult UNavigationSystemV1::GetPathLength(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, float* PathLength, class ANavigationData* NavData, class UClass* FilterClass, class UObject* querier, float CostLimit)
	{
	 ...
	 * 		float                                              CostLimit                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	ENavigationQueryResult UNavigationSystemV1::GetPathCost(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, float* PathCost, class ANavigationData* NavData, class UClass* FilterClass, class UObject* querier, float CostLimit)
	{
	 ...
	 * 		float                                              CostLimit                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	class UNavigationPath* UNavigationSystemV1::FindPathToLocationSynchronously(class UObject* WorldContextObject, const struct FVector& PathStart, const struct FVector& PathEnd, class AActor* PathfindingContext, class UClass* FilterClass, float CostLimit)
	{
	 ...
	 * 		float                                              CostLimit                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	class UNavigationPath* UNavigationSystemV1::FindPathToActorSynchronously(class UObject* WorldContextObject, const struct FVector& PathStart, class AActor* GoalActor, float TetherDistance, class AActor* PathfindingContext, class UClass* FilterClass, float CostLimit)
	{
