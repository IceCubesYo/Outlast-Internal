...
namespace CG
{
	...
	public:
		...
		TArray<class ACameraIntercom01_BP_C*>                      CameraIntercoms;                                         // 0x0288(0x0010) Edit, BlueprintVisible, DisableEditOnTemplate
		...
		class ARemoteCameraIntercom01_BP_C*                        RemoteCameraIntercom;                                    // 0x02A0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void Destruct();
		void ExitMenu();
		void SetCameraIntercom(class ARemoteCameraIntercom01_BP_C* CameraIntercom);
