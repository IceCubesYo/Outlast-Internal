...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MansionSwitchAppleHandNotify.MansionSwitchAppleHandNotify_C.Received_Notify");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass MansionSwitchAppleHandNotify.MansionSwitchAppleHandNotify_C");
		return ptr;
	}
