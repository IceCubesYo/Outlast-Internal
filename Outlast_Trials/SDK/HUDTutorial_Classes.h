...
namespace CG
{
	 ...
	 */
	class UHUDTutorial_C : public URBHUDElementWidget
	{
	public:
		...
		class UImage*                                              Image_176;                                               // 0x02F8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class URichTextBlock*                                      RichTextBlock_63;                                        // 0x0308(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		bool ShouldShow();
		void Construct();
		void OnShowHUDTutorial_Event_1(const struct FHUDTutorialTextData& tutorialData);
		void OnHideHUDTutorial_Event_1();
		void Event_Show();
		void Event_Hide();
		void ExecuteUbergraph_HUDTutorial(int32_t EntryPoint);
