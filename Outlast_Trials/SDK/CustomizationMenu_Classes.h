...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_34O0[0x6];                                   // 0x03A2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		float                                                      RotateFactor;                                            // 0x03B8(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_HO36[0x4];                                   // 0x03BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void PreviewCosts(const struct FUICustomizationItem& CustoItem);
		void UpdateCustoDetails(const struct FUICustomizationItem& CustoItem);
		...
		void GamepadNav_StartRotation(float RotateFactor);
