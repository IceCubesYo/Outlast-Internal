...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.TestCameraShake");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.SimpleCameraShakePattern");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.ConstantCameraShakePattern");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.CompositeCameraShakePattern");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.DefaultCameraShakeBase");
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShake.StartMatineeCameraShakeFromSource");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShake.StartMatineeCameraShake");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShake.ReceiveStopShake");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShake.ReceivePlayShake");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShake.ReceiveIsFinished");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShake.BlueprintUpdateCameraShake");
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.MatineeCameraShake");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.MatineeCameraShakePattern");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.MovieSceneMatineeCameraShakeEvaluator");
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function GameplayCameras.MatineeCameraShakeFunctionLibrary.Conv_MatineeCameraShake");
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.MatineeCameraShakeFunctionLibrary");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.PerlinNoiseCameraShakePattern");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class GameplayCameras.WaveOscillatorCameraShakePattern");
		return ptr;
	}
