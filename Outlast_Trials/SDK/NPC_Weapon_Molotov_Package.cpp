...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function NPC_Weapon_Molotov.NPC_Weapon_Molotov_C.Event_ActivateEffects");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function NPC_Weapon_Molotov.NPC_Weapon_Molotov_C.Event_DeactivateEffects");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function NPC_Weapon_Molotov.NPC_Weapon_Molotov_C.ExecuteUbergraph_NPC_Weapon_Molotov");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass NPC_Weapon_Molotov.NPC_Weapon_Molotov_C");
		return ptr;
	}
