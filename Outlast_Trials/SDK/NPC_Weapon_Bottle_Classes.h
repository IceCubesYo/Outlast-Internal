...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass NPC_Weapon_Bottle.NPC_Weapon_Bottle_C
	 * Size -> 0x0018 (FullSize[0x02B0] - InheritedSize[0x0298])
	 */
	class ANPC_Weapon_Bottle_C : public ARBNPCWeapon
	{
	public:
		...
		class UStaticMeshComponent*                                Bottle01;                                                // 0x02A8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
