...
namespace CG
{
	...
	public:
		...
		class UStaticMeshComponent*                                Bottle01;                                                // 0x02B8(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
