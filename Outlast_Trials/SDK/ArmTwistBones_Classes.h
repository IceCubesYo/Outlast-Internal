...
namespace CG
{
	 ...
	 */
	class UArmTwistBones_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_EHVH[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ArmTwistBones(int32_t EntryPoint);
