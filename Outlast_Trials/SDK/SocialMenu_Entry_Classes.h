...
namespace CG
{
	 ...
	 */
	class USocialMenu_Entry_C : public URBSocialMenuEntry
	{
	public:
		...
		class UTextBlock*                                          OnlineStatusText;                                        // 0x04B0(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_YASB[0x5];                                   // 0x04F3(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_SocialMenu_Entry(int32_t EntryPoint);
