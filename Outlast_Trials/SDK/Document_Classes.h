...
namespace CG
{
	 ...
	 */
	class UDocument_C : public URBMenuWidget
	{
	public:
		...
		class UVerticalBox*                                        VerticalBox_2;                                           // 0x0368(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_Document(int32_t EntryPoint);
