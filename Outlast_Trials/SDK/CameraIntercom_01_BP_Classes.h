...
namespace CG
{
	 ...
	 */
	class ACameraIntercom01_BP_C : public AActor
	{
	public:
		...
		class UStaticMeshComponent*                                Speaker01;                                               // 0x0270(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_LP3E[0x1];                                   // 0x02A7(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRBStageID                                          SpecificStage;                                           // 0x02A8(0x0028) Edit, BlueprintVisible
		float                                                      DeltaSeconds;                                            // 0x02D0(0x0004) Edit, BlueprintVisible, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_ADO7[0x4];                                   // 0x02D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_CameraIntercom01_BP(int32_t EntryPoint);
