...
namespace CG
{
	...
	public:
		bool                                                       ReturnValue;                                             // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_RJNF[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_IVUK[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	/**
	 * Function Client_InGameMenu.Client_InGameMenu_C.Event_MenuTabLeft_Released
	 */
	struct UClient_InGameMenu_C_Event_MenuTabLeft_Released_Params
	{	};

	/**
	 * Function Client_InGameMenu.Client_InGameMenu_C.Event_MenuTabRight_Released
	 */
	struct UClient_InGameMenu_C_Event_MenuTabRight_Released_Params
	{	};
