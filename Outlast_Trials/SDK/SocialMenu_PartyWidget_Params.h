...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_NZHN[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct USocialMenu_PartyWidget_C_SetupEditorPreview_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_N1FW[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
