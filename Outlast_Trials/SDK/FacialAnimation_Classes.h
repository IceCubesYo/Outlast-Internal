...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_1ZOB[0x8];                                   // 0x0880(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CLA5[0x2C];                                  // 0x0894(0x002C) MISSED OFFSET (PADDING)
