...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.UpdateApplyChangesBtnVisibility");
	 ...
	 * 		class URBMenuOptionsEntry*                         EntryCreated                                               (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UOptionsMenu_C::CreateOptionEntry(class UOptionsTab_C* OptionTab, const struct FOptionData& OptionData, class URBMenuOptionsEntry** EntryCreated)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.CreateOptionEntry");
		...
		if (EntryCreated != nullptr)
			*EntryCreated = params.EntryCreated;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.CreateOptionTabs");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.ConditionalShowApplyDialog");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Get_ApplyChangeBtn_Visibility_1");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.PreNavigationChangeAction");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Event_UpdateNavigation");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.OnSubButtonClicked");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.ExecuteChangesDecision");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.ApplyChangesToCurrentTab");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Finished_B30461B244A64F1C78C486945F767F0A");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.PreConstruct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Construct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.BndEvt__RBMenuButton_83_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.BndEvt__RBMenuButton_177_K2Node_ComponentBoundEvent_1_OnClicked__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.BndEvt__RBMenuButton_K2Node_ComponentBoundEvent_2_OnClicked__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Event_StartTransitionIn");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Event_StartTransitionOut");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.OnReleasedApply");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.OnReleasedReset");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.OnFullscreenOrDesktopSettingsChanged");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Event_OnMenuTabSwitched");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Event_InputSourceChanged");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.Event_RefreshAllEntries");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function OptionsMenu.OptionsMenu_C.ExecuteUbergraph_OptionsMenu");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass OptionsMenu.OptionsMenu_C");
		return ptr;
	}
