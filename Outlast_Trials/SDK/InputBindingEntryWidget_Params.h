...
namespace CG
{
	...
	/**
	 * Function InputBindingEntryWidget.InputBindingEntryWidget_C.PreConstruct
	 */
	struct UInputBindingEntryWidget_C_PreConstruct_Params
	{
	public:
	...
	/**
	 * Function InputBindingEntryWidget.InputBindingEntryWidget_C.Construct
	 */
	struct UInputBindingEntryWidget_C_Construct_Params
	{	};
