...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function ACLPlugin.AnimationCompressionLibraryDatabase.SetVisualFidelity");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function ACLPlugin.AnimationCompressionLibraryDatabase.GetVisualFidelity");
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimationCompressionLibraryDatabase");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimBoneCompressionCodec_ACLBase");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimBoneCompressionCodec_ACL");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimBoneCompressionCodec_ACLCustom");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimBoneCompressionCodec_ACLDatabase");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimBoneCompressionCodec_ACLSafe");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class ACLPlugin.AnimCurveCompressionCodec_ACL");
		return ptr;
	}
