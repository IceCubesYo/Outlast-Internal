...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XFGX[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
		class FString                                              outErrorMsg;                                             // 0x0008(0x0010)  (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash)
		bool                                                       ReturnValue;                                             // 0x0018(0x0001)  (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_R7TI[0x3];                                   // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_CTXS[0x7];                                   // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	public:
		...
		unsigned char                                              UnknownData_RSQ8[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	...
	/**
	 * Function RBLight_BP.RBLight_BP_C.BP_PrepareMapCheck
	 */
	struct ARBLight_BP_C_BP_PrepareMapCheck_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_4S16[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function RBLight_BP.RBLight_BP_C.ReceiveBeginPlay
	 */
	struct ARBLight_BP_C_ReceiveBeginPlay_Params
	{	};

	/**
	 * Function RBLight_BP.RBLight_BP_C.OnRandomStateChanged
	 */
	struct ARBLight_BP_C_OnRandomStateChanged_Params
	{	};
