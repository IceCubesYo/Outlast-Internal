...
namespace CG
{
	 ...
	 * Size -> 0x0352 (FullSize[0x060A] - InheritedSize[0x02B8])
	 */
	class UNightVision_Goggle_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_06H8[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_MVG3[0x4];                                   // 0x05FC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
