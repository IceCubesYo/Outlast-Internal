...
namespace CG
{
	 ...
	 */
	struct ASplineMeshBase_BP_C_ConstructSplineMeshes_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_BVHW[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		struct FRotator                                            RelativeTransformRotation;                               // 0x0010(0x000C)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
