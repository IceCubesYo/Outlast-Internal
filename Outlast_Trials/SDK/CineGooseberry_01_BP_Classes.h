...
namespace CG
{
	 ...
	 */
	class ACineGooseberry01_BP_C : public ACineCharacterBase_BP_C
	{
	public:
		unsigned char                                              UnknownData_ESE5[0x4];                                   // 0x026C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
