...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.Setup");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.GamepadNav_MenuConfirm_Release");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.GamepadNav_MenuConfirm");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnFocusLost");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnFocusReceived");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.GetIsEquipped");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.SetIsEquipped");
	 ...
	 */
	void UPerkUpgradeButton_C::InitializeEmptySlot(int32_t SlotIndex)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.InitializeEmptySlot");
	 ...
	 * 		int32_t                                            SlotIndex                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UPerkUpgradeButton_C::InitializeLockedSlot(int32_t SlotIndex)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.Initialize Locked Slot");
		
		UPerkUpgradeButton_C_InitializeLockedSlot_Params params {};
		params.SlotIndex = SlotIndex;
	 ...
	 */
	void UPerkUpgradeButton_C::Initialize(const struct FMenuUpgradeItemInfo& itemUpgradeInfo, bool inIsLoadout, int32_t SlotIndex, bool bInIsSlot)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.Initialize");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.PreConstruct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.BndEvt__CategoryButtonWidget_K2Node_ComponentBoundEvent_0_Event_OnClicked__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.BndEvt__CategoryButtonWidget_K2Node_ComponentBoundEvent_1_Event_OnHovered__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.BndEvt__CategoryButtonWidget_K2Node_ComponentBoundEvent_2_Event_OnUnhovered__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.BndEvt__CategoryButtonWidget_K2Node_ComponentBoundEvent_3_Event_OnPressed__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.BndEvt__CategoryButtonWidget_K2Node_ComponentBoundEvent_4_Event_OnReleased__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.ExecuteUbergraph_PerkUpgradeButton");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnReleasedEvent__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnPressedEvent__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnUnhoveredEvent__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnHoveredEvent__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function PerkUpgradeButton.PerkUpgradeButton_C.OnClickedEvent__DelegateSignature");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass PerkUpgradeButton.PerkUpgradeButton_C");
		return ptr;
	}
