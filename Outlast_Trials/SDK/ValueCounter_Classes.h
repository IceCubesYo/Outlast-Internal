...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DF2S[0x4];                                   // 0x02A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FSlateBrush                                         BaseBrush;                                               // 0x02A8(0x0088) Edit, BlueprintVisible, DisableEditOnInstance
		struct FSlateColor                                         NormalTint;                                              // 0x0330(0x0028) Edit, BlueprintVisible, DisableEditOnInstance
		struct FSlateColor                                         HighlightedTint;                                         // 0x0358(0x0028) Edit, BlueprintVisible, DisableEditOnInstance
