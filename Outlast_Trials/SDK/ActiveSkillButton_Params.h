...
namespace CG
{
	 ...
	 */
	struct UActiveSkillButton_C_InitializeEmptySlot_Params
	{	};
	...
	public:
		...
		bool                                                       bInIsSlot;                                               // 0x0108(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
		unsigned char                                              UnknownData_DJ9Q[0x7];                                   // 0x0109(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
