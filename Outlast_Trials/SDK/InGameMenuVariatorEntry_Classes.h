...
namespace CG
{
	 ...
	 */
	class UInGameMenuVariatorEntry_C : public UUserWidget
	{
	public:
		...
		unsigned char                                              UnknownData_TCN1[0x7];                                   // 0x0299(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class FScriptMulticastDelegate                             OnAnimationCompleted;                                    // 0x02D0(0x0010) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable
	...
	public:
		...
		void ExecuteUbergraph_InGameMenuVariatorEntry(int32_t EntryPoint);
