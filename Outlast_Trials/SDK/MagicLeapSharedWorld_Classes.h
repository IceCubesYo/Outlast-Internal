...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3QWN[0xA4];                                  // 0x0354(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_K2ZN[0x18];                                  // 0x0598(0x0018) MISSED OFFSET (PADDING)
