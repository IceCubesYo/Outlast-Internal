...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CompleteStamp.CompleteStamp_C.PlayStampAnim");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CompleteStamp.CompleteStamp_C.ExecuteUbergraph_CompleteStamp");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CompleteStamp.CompleteStamp_C");
		return ptr;
	}
