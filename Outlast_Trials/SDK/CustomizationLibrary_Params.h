...
namespace CG
{
	...
	{
	public:
		struct FAnalogInputEvent                                   AnalogInput;                                             // 0x0000(0x0040)  (BlueprintVisible, BlueprintReadOnly, Parm)
	...
	public:
		...
		unsigned char                                              UnknownData_35NY[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_Z79R[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
