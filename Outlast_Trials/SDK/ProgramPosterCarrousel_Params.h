...
namespace CG
{
	 ...
	 */
	struct UProgramPosterCarrousel_C_CyclePosters_Params
	{
	public:
		...
		unsigned char                                              UnknownData_JUBK[0x7];                                   // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
