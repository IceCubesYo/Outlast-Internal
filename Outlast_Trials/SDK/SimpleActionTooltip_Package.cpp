...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function SimpleActionTooltip.SimpleActionTooltip_C.PreConstruct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function SimpleActionTooltip.SimpleActionTooltip_C.Construct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function SimpleActionTooltip.SimpleActionTooltip_C.ExecuteUbergraph_SimpleActionTooltip");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SimpleActionTooltip.SimpleActionTooltip_C");
		return ptr;
	}
