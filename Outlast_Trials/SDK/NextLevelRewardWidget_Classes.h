...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_UN9Z[0x2];                                   // 0x0292(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FRewardUIData                                       RewardUIData;                                            // 0x02A0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FSlateColor                                         IconTintColor;                                           // 0x02B8(0x0028) Edit, BlueprintVisible, DisableEditOnInstance
		class FText                                                ForcedText;                                              // 0x02E0(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
