...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MPAS[0x4];                                   // 0x028C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6OJ8[0x3];                                   // 0x02E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void OnItemEquipped(struct FUICustomizationItem* NewEquippedItem);
		void Event_InputSourceChanged(bool bIsGamepad);
		void TryUpdateEquippedOptionWidget(class UCustomizationOptionThumbnail_C* NewOption);
