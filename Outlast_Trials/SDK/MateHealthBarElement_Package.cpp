...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.ForceValue");
	 ...
	 */
	void UMateHealthBarElement_C::SetEntireBar(bool Empty)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.SetEntireBar");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.SetBarHeight");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.UpdateTints");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.UpdateTween");
	 ...
	 */
	void UMateHealthBarElement_C::StartNewTween(float NewValue, bool StartsOutsideBracket)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.Start New Tween");
		
		UMateHealthBarElement_C_StartNewTween_Params params {};
		params.NewValue = NewValue;
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.PreConstruct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.Construct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.Tick");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.ExecuteUbergraph_MateHealthBarElement");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.BleedoutCompleted__DelegateSignature");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MateHealthBarElement.MateHealthBarElement_C.TweenCompleted__DelegateSignature");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass MateHealthBarElement.MateHealthBarElement_C");
		return ptr;
	}
