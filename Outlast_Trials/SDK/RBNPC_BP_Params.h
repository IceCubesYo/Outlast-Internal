...
namespace CG
{
	...
	/**
	 * Function RBNPC_BP.RBNPC_BP_C.Event_OnStartRagePaintState
	 */
	struct ARBNPC_BP_C_Event_OnStartRagePaintState_Params
	{	};

	/**
	 * Function RBNPC_BP.RBNPC_BP_C.Event_OnEndRagePaintState
	 */
	struct ARBNPC_BP_C_Event_OnEndRagePaintState_Params
	{	};
