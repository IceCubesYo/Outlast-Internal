...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PG5F[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};

	/**
	 * Function tvChannel_BP.tvChannel_BP_C.Set Material Dynamic Parameter
	 */
	struct AtvChannel_BP_C_SetMaterialDynamicParameter_Params
	{
	public:
		...
		unsigned char                                              UnknownData_ELFE[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	public:
		...
		unsigned char                                              UnknownData_72RE[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
	 ...
	 */
	struct AtvChannel_BP_C_CreateDynamicTexture_Params
	{	};

	/**
	 * Function tvChannel_BP.tvChannel_BP_C.Set Test Screen Mat
	 */
	struct AtvChannel_BP_C_SetTestScreenMat_Params
	{
	public:
	...
	public:
		...
		float                                                      _0FontScale;                                             // 0x0028(0x0004)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_WO8W[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	/**
	 * Function tvChannel_BP.tvChannel_BP_C.OnAnimationFinihsed
	 */
	struct AtvChannel_BP_C_OnAnimationFinihsed_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_2H29[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
