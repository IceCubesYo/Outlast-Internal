...
namespace CG
{
	...
	/**
	 * Function InputBindingsMenu.InputBindingsMenu_C.BndEvt__ApplyChangeBtn_K2Node_ComponentBoundEvent_4_OnClicked__DelegateSignature
	 */
	struct UInputBindingsMenu_C_BndEvt__ApplyChangeBtn_K2Node_ComponentBoundEvent_4_OnClicked__DelegateSignature_Params
	{
	public:
		class URBMenuButton_C*                                     Button;                                                  // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	};
