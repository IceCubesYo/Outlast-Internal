...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_V4SM[0x8];                                   // 0x04B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_G5B0[0x6];                                   // 0x04C2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_E4YM[0x4];                                   // 0x050C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
