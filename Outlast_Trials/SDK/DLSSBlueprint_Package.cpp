...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.IsDLAAEnabled");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function DLSSBlueprint.DLSSLibrary.EnableDLAA");
