...
namespace CG
{
	 ...
	 */
	class USE_MansionTheatre_Curtain_AnimBP_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_CS1W[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		struct FPointerToUberGraphFrame                            UberGraphFrame;                                          // 0x02C0(0x0008) ZeroConstructor, Transient, DuplicateTransient
		struct FAnimNode_Root                                      AnimGraphNode_Root;                                      // 0x02C8(0x0030)
		struct FAnimNode_BlendListByBool                           AnimGraphNode_BlendListByBool_2;                         // 0x02F8(0x00A8)
		struct FAnimNode_BlendListByBool                           AnimGraphNode_BlendListByBool;                           // 0x03A0(0x00A8)
	...
	public:
		...
		void ExecuteUbergraph_SE_MansionTheatre_Curtain_AnimBP(int32_t EntryPoint);
