...
namespace CG
{
	 ...
	 * Size -> 0x09FA (FullSize[0x0CEA] - InheritedSize[0x02F0])
	 */
	...
	public:
		...
		unsigned char                                              UnknownData_D107[0x3];                                   // 0x0CC1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QQNB[0x6];                                   // 0x0CDA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
