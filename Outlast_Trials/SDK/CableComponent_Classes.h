...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_KYCX[0x8];                                   // 0x04B8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_266G[0x3];                                   // 0x0511(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O0V6[0x4];                                   // 0x0534(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FCableParticle>                              PreSimulatedParticles;                                   // 0x0538(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_4JP0[0x18];                                  // 0x0548(0x0018) MISSED OFFSET (PADDING)
