...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function LoadoutMenuLibrary.LoadoutMenuLibrary_C.GetActiveSkillColor");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass LoadoutMenuLibrary.LoadoutMenuLibrary_C");
		return ptr;
	}
