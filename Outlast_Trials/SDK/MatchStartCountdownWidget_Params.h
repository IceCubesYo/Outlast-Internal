...
namespace CG
{
	...
	{
	public:
		struct FFindPartyState                                     FindPartyState;                                          // 0x0000(0x0018)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
	};
	...
	public:
		class ARBLobbyPlayerState*                                 RBLobbyPlayerState;                                      // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		struct FFindPartyState                                     FindPartyState;                                          // 0x0008(0x0018)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
	};
