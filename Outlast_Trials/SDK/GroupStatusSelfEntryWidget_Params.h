...
namespace CG
{
	...
	/**
	 * Function GroupStatusSelfEntryWidget.GroupStatusSelfEntryWidget_C.Event_MaxDisplayNameLengthUpdated
	 */
	struct UGroupStatusSelfEntryWidget_C_Event_MaxDisplayNameLengthUpdated_Params
	{	};

	/**
	 * Function GroupStatusSelfEntryWidget.GroupStatusSelfEntryWidget_C.Construct
	 */
	struct UGroupStatusSelfEntryWidget_C_Construct_Params
	{	};
