...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPF_FX_Footstep_PhyxMatTag.BPF_FX_Footstep_PhyxMatTag_C.tmpPlayLandingFX");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPF_FX_Footstep_PhyxMatTag.BPF_FX_Footstep_PhyxMatTag_C.tmpPlayFootstepFX");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPF_FX_Footstep_PhyxMatTag.BPF_FX_Footstep_PhyxMatTag_C.tmpPlayVFX");
	 ...
	 */
	void UBPF_FX_Footstep_PhyxMatTag_C::FootstepFXLanding(class ARBPawn* Pawn, class UObject* __WorldContext, int32_t* Index)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPF_FX_Footstep_PhyxMatTag.BPF_FX_Footstep_PhyxMatTag_C.Footstep FX Landing");
		
		UBPF_FX_Footstep_PhyxMatTag_C_FootstepFXLanding_Params params {};
		params.Pawn = Pawn;
		params.__WorldContext = __WorldContext;
	 ...
	 * 		int32_t                                            Index                                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	 */
	void UBPF_FX_Footstep_PhyxMatTag_C::FootstepFXRun(class ARBPawn* Pawn, const struct FFootstepData& FootstepData, class UObject* __WorldContext, int32_t* Index)
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BPF_FX_Footstep_PhyxMatTag.BPF_FX_Footstep_PhyxMatTag_C.Footstep FX Run");
		
		UBPF_FX_Footstep_PhyxMatTag_C_FootstepFXRun_Params params {};
		params.Pawn = Pawn;
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BPF_FX_Footstep_PhyxMatTag.BPF_FX_Footstep_PhyxMatTag_C");
		return ptr;
	}
