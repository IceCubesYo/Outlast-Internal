...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass("Class TemplateSequence.SequenceCameraShakePattern");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class TemplateSequence.TemplateSequencePropertyScalingInstantiatorSystem");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class TemplateSequence.TemplateSequencePropertyScalingEvaluatorSystem");
		return ptr;
	}
