...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function SocialMenu_Tab_Recent.SocialMenu_Tab_Recent_C.OnFocusReceived");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function SocialMenu_Tab_Recent.SocialMenu_Tab_Recent_C.Deactivate");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function SocialMenu_Tab_Recent.SocialMenu_Tab_Recent_C.Activate");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass SocialMenu_Tab_Recent.SocialMenu_Tab_Recent_C");
		return ptr;
	}
