...
namespace CG
{
	 ...
	 * Size -> 0x00B1 (FullSize[0x0399] - InheritedSize[0x02E8])
	 */
	...
	public:
		...
		class UImage*                                              VisualDetectionImage;                                    // 0x0340(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		float                                                      IsInDarknessValue;                                       // 0x0348(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      CrosshairValue;                                          // 0x034C(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FLinearColor                                        NPCHearingColor;                                         // 0x0350(0x0010) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		struct FLinearColor                                        NormalColor;                                             // 0x0360(0x0010) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		TArray<class UTexture2D*>                                  VisualDetectionImages;                                   // 0x0370(0x0010) Edit, BlueprintVisible
		TArray<class UTexture2D*>                                  DarknessDetectionImages;                                 // 0x0380(0x0010) Edit, BlueprintVisible
		float                                                      NPCVisualDetectionSmoothed;                              // 0x0390(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		float                                                      DarknessDetectionSmoothed;                               // 0x0394(0x0004) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		bool                                                       DetectedDisplay;                                         // 0x0398(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor
	...
	public:
		...
		void UpdateCrosshairV2(float DeltaTime);
