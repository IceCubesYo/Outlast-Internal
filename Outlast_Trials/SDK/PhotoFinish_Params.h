...
namespace CG
{
	...
	{
	public:
		struct FRewardUIData                                       RewardUIData;                                            // 0x0000(0x0018)  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
		class UProgramTrialRewardWidget_C*                         rewardWidget;                                            // 0x0018(0x0008)  (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
		bool                                                       bCreated;                                                // 0x0020(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
	...
	/**
	 * Function PhotoFinish.PhotoFinish_C.Event_MenuTabLeft_Released
	 */
	struct UPhotoFinish_C_Event_MenuTabLeft_Released_Params
	{	};

	/**
	 * Function PhotoFinish.PhotoFinish_C.Event_MenuTabRight_Released
	 */
	struct UPhotoFinish_C_Event_MenuTabRight_Released_Params
	{	};
