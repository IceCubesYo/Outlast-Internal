...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_Q3YV[0x6];                                   // 0x0332(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FGameMessageAudioParams                             AudioParams;                                             // 0x0350(0x0010) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		...
		unsigned char                                              UnknownData_H3FH[0x6];                                   // 0x036A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IW8B[0x6];                                   // 0x038A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
