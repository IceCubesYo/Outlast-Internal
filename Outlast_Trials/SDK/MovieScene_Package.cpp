...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MovieScene.MovieSceneSequencePlayer.RestoreState");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function MovieScene.MovieSceneSequencePlayer.GetSequence");
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.MovieSceneDeterminismSource");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.MovieSceneEvaluationHook");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.MovieSceneEvaluationHookSystem");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.MovieSceneHookSection");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.MovieSceneSequenceActor");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.TestMovieSceneEvalHookTrack");
		return ptr;
	}
	...
	{
		static UClass* ptr = UObject::FindClass("Class MovieScene.TestMovieSceneEvalHookSection");
		return ptr;
	}
