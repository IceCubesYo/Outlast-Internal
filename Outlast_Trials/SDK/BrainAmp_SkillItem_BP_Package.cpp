...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BrainAmp_SkillItem_BP.BrainAmp_SkillItem_BP_C.Event_OnActivate");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BrainAmp_SkillItem_BP.BrainAmp_SkillItem_BP_C.Event_OnDeployed");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function BrainAmp_SkillItem_BP.BrainAmp_SkillItem_BP_C.ExecuteUbergraph_BrainAmp_SkillItem_BP");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BrainAmp_SkillItem_BP.BrainAmp_SkillItem_BP_C");
		return ptr;
	}
