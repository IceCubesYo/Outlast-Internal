...
namespace CG
{
	...
	{
	public:
		struct FRBProgramInfoRow                                   programInfo;                                             // 0x0000(0x00C0)  (BlueprintVisible, BlueprintReadOnly, Parm)
		bool                                                       bLocked;                                                 // 0x00C0(0x0001)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	};
	 ...
	 */
	struct UProgramPosterCarrouselEntry_C_OnHovered_Params
	{	};

	/**
	 * Function ProgramPosterCarrouselEntry.ProgramPosterCarrouselEntry_C.On Unhovered
	 */
	struct UProgramPosterCarrouselEntry_C_OnUnhovered_Params
	{	};

	/**
	 * Function ProgramPosterCarrouselEntry.ProgramPosterCarrouselEntry_C.On Clicked
	 */
	struct UProgramPosterCarrouselEntry_C_OnClicked_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_GSCQ[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
