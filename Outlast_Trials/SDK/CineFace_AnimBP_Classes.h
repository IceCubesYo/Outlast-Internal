...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_0I8F[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		class USkeletalMeshComponent*                              SourceMeshComponent;                                     // 0x0868(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash
