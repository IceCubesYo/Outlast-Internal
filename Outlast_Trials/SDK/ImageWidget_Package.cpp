...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function ImageWidget.ImageWidget_C.SetImage");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass ImageWidget.ImageWidget_C");
		return ptr;
	}
