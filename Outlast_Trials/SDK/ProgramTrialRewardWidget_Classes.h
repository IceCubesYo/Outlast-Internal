...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_95RR[0x2];                                   // 0x02BA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		struct FRewardUIData                                       RewardUIData;                                            // 0x02C8(0x0018) Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor
		struct FSlateColor                                         IconTintColor;                                           // 0x02E0(0x0028) Edit, BlueprintVisible, DisableEditOnInstance
		class FText                                                ForcedText;                                              // 0x0308(0x0018) Edit, BlueprintVisible, DisableEditOnInstance
