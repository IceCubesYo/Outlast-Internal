...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function VoiceChatOverheadWidget.VoiceChatOverheadWidget_C.Event_Refresh");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function VoiceChatOverheadWidget.VoiceChatOverheadWidget_C.ExecuteUbergraph_VoiceChatOverheadWidget");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass VoiceChatOverheadWidget.VoiceChatOverheadWidget_C");
		return ptr;
	}
