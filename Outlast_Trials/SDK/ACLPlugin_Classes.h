...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FOA6[0x110];                                 // 0x0048(0x0110) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TRQR[0x4];                                   // 0x015C(0x0004) MISSED OFFSET (PADDING)
