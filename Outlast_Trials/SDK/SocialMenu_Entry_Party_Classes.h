...
namespace CG
{
	 ...
	 */
	class USocialMenu_Entry_Party_C : public URBSocialMenuEntry
	{
	public:
		...
		class UImage*                                              PendingNotificationIcon;                                 // 0x04B8(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_DYXT[0x5];                                   // 0x04EB(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class USocialMenu_ContextualMenu_C*                        ContextualMenu_1;                                        // 0x04F0(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash
	...
	public:
		...
		void ExecuteUbergraph_SocialMenu_Entry_Party(int32_t EntryPoint);
