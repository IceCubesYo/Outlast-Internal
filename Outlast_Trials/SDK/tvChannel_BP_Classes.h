...
namespace CG
{
	 ...
	 * Size -> 0x0191 (FullSize[0x0471] - InheritedSize[0x02E0])
	 */
	...
	public:
		...
		EPixelFormat                                               PixelFormat;                                             // 0x0358(0x0001) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		unsigned char                                              UnknownData_NUQR[0x7];                                   // 0x0359(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FTextBox                                            TextBox;                                                 // 0x0360(0x0090) Edit, BlueprintVisible, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_BR9V[0x3];                                   // 0x03F9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		class UBinkMediaPlayer*                                    BinkMediaPlayer01;                                       // 0x0400(0x0008) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash
		...
		unsigned char                                              UnknownData_LB61[0x3];                                   // 0x0411(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_VQF3[0x7];                                   // 0x0451(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void SetMaterialDynamicParameter(float Height, float ChromaticAberation, float NoiseDeform, float RefreshJumpLuminosity, float Interlace, class UTexture* TVmovie);
		void PlaySoundFromTV(class UAkAudioEvent* Sound, bool PlayOnNarrator);
		void PlayRandomAnim(class UDataTable* DataTable, bool LoopSingleAnimation, bool OnlySingleRow);
		void ShouldLoopAnim(bool* Value);
		void ValidateTexture();
		void GetRandomDataTableRow(class UDataTable* DataTable, class FName* RowName);
		void CreateDynamicTexture();
		void SetTestScreenMat(class UMaterialInterface* Material);
		void UserConstructionScript();
		void ReceiveBeginPlay();
		void UpdateText(const class FString& string, const class FText& Text, float _0FontScale);
