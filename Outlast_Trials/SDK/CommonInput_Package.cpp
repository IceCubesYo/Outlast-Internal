...
namespace CG
{
	...
	{
		static UClass* ptr = UObject::FindClass("Class CommonInput.CommonUIInputData");
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputBaseControllerData.GetRegisteredGamepads");
	...
	{
		static UClass* ptr = UObject::FindClass("Class CommonInput.CommonInputBaseControllerData");
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSettings.GetRegisteredPlatforms");
	...
	{
		static UClass* ptr = UObject::FindClass("Class CommonInput.CommonInputSettings");
		return ptr;
	}
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.ShouldShowInputKeys");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.SetGamepadInputType");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.SetCurrentInputType");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.IsUsingPointerInput");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.IsInputMethodActive");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.GetDefaultInputType");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.GetCurrentInputType");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CommonInput.CommonInputSubsystem.GetCurrentGamepadName");
	...
	{
		static UClass* ptr = UObject::FindClass("Class CommonInput.CommonInputSubsystem");
		return ptr;
	}
