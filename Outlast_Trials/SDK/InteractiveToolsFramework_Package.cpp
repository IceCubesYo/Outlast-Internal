...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction URBVertexPaintUserSettings.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* URBVertexPaintUserSettings::StaticClass()
	{
		static UClass* ptr = UObject::FindClass("Class InteractiveToolsFramework.RBVertexPaintUserSettings");
		return ptr;
	}
