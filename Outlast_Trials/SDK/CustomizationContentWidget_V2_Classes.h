...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_SJ9J[0x3];                                   // 0x049D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EL2L[0x6];                                   // 0x04BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_B3YX[0x4];                                   // 0x055C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void EventOnItemClicked(const struct FUICustomizationItem& Item);
		void Destruct();
		void Construct();
		...
		void OnItemPreviewed__DelegateSignature(const struct FUICustomizationItem& CustoItem);
