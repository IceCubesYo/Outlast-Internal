...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.HeadMountedDisplayFunctionLibrary.GetPlayAreaBounds");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.HeadMountedDisplayFunctionLibrary.BreakKey");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function HeadMountedDisplay.HandKeypointConversion.Conv_HandKeypointToInt32");
	...
	{
		static UClass* ptr = UObject::FindClass("Class HeadMountedDisplay.HandKeypointConversion");
		return ptr;
	}
