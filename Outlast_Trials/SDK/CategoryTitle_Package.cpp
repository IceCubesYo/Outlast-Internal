...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CategoryTitle.CategoryTitle_C.SetText");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CategoryTitle.CategoryTitle_C.PreConstruct");
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function CategoryTitle.CategoryTitle_C.ExecuteUbergraph_CategoryTitle");
	...
	{
		static UClass* ptr = UObject::FindClass("WidgetBlueprintGeneratedClass CategoryTitle.CategoryTitle_C");
		return ptr;
	}
