...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_OMUX[0x1B];                                  // 0x0065(0x001B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IHBJ[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AR3H[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_GX2J[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IISZ[0x50];                                  // 0x0060(0x0050) MISSED OFFSET (PADDING)
