...
namespace CG
{
	...
	public:
		...
		void FootstepFXLanding(class ARBPawn* Pawn, class UObject* __WorldContext, int32_t* Index);
		void FootstepFXRun(class ARBPawn* Pawn, const struct FFootstepData& FootstepData, class UObject* __WorldContext, int32_t* Index);
