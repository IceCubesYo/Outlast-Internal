...
namespace CG
{
	...
	/**
	 * Function QuitMenu.QuitMenu_C.Event_MenuConfirm_Released
	 */
	struct UQuitMenu_C_Event_MenuConfirm_Released_Params
	{	};
	...
	public:
		...
		unsigned char                                              UnknownData_IKS7[0x4];                                   // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	};
