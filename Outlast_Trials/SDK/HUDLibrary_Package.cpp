...
namespace CG
{
	...
	{
		static UFunction* fn = UObject::FindObject<UFunction>("Function HUDLibrary.HUDLibrary_C.FadeIfNecessary");
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass HUDLibrary.HUDLibrary_C");
		return ptr;
	}
