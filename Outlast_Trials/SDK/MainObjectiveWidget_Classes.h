...
namespace CG
{
	 ...
	 * Size -> 0x00B2 (FullSize[0x03D4] - InheritedSize[0x0322])
	 */
	class UMainObjectiveWidget_C : public UObjectiveWidgetBase_C
	{
	public:
		unsigned char                                              UnknownData_U1QX[0x6];                                   // 0x0322(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_80LP[0x3];                                   // 0x03B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I0N3[0x4];                                   // 0x03BC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
